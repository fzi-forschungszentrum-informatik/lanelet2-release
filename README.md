...
## lanelet2 (foxy) - 1.2.1-1

The packages in the `lanelet2` repository were released into the `foxy` distro by running `/usr/local/bin/bloom-release lanelet2 --rosdistro foxy` on `Wed, 10 May 2023 16:41:17 -0000`
...
## lanelet2 (noetic) - 1.2.1-2

The packages in the `lanelet2` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release lanelet2 --rosdistro noetic` on `Wed, 10 May 2023 16:36:16 -0000`
...
## lanelet2 (noetic) - 1.2.1-1

The packages in the `lanelet2` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release lanelet2 --rosdistro noetic` on `Wed, 10 May 2023 16:22:16 -0000`
...
## lanelet2 (noetic) - 1.2.0-2

The packages in the `lanelet2` repository were released into the `noetic` distro by running `/usr/local/bin/bloom-release lanelet2 --rosdistro noetic` on `Wed, 01 Feb 2023 15:31:03 -0000`
...
## lanelet2 (noetic) - 1.2.0-1

The packages in the `lanelet2` repository were released into the `noetic` distro by running `/home/immel/.local/bin/bloom-release lanelet2 --rosdistro noetic` on `Mon, 30 Jan 2023 16:56:33 -0000`
